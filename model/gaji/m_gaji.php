<?php
	...
	function updateGaji($kode_gaji,$kode_karyawan,$kode_bonus,$periode,$tahun,$tanggal,$gaji_pokok,$presentase_bengkel,$bonus_bengkel,$presentase_oli,$bonus_oli,$bonus_full_absen,$jumlah_bonus,$thr,$potong_terlambat,$total_gaji){
		global $mysqli;
		$update= $mysqli->query("UPDATE tb_gaji SET kode_karyawan='$kode_karyawan',kode_bonus='$kode_bonus',periode='$periode', tahun='$tahun' , tanggal='$tanggal',gaji_pokok='$gaji_pokok',presentase_bengkel='$presentase_bengkel',bonus_bengkel='$bonus_bengkel',presentase_oli='$presentase_oli',bonus_oli='$bonus_oli',bonus_full_absen='$bonus_full_absen',jumlah_bonus='$jumlah_bonus',thr='$thr',potong_terlambat='$potong_terlambat',total_gaji='$total_gaji' WHERE kode_gaji='$kode_gaji'")or die(mysqli_connect_error());
		return $update;
	}
