<?php
	...
	function updateBonus($kode_bonus,$kode_absensi,$pendapatan_bengkel,$pendapatan_oli,$jumlah_bonus){
		$update= $mysqli->query("UPDATE tb_bonus SET kode_bonus='$kode_bonus', kode_absensi='$kode_absensi', pendapatan_bengkel='$pendapatan_bengkel', pendapatan_oli='$pendapatan_oli', jumlah_bonus='$jumlah_bonus' WHERE kode_bonus='$kode_bonus'")or die(mysqli_connect_error());
		return $update;
	}
